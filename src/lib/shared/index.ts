        ...
        try {
            if (!config.test) {
                validatedData = await validateReceipt({
                    ...
                    excludeOldTransactions: config.appleExcludeOldTransactions,
                });
            }
...
export const getPurchaseData = function (purchase?: IReceiptValidationResponseBody): PurchasedItem[] | null {
